// Copyright (c) 2014-present The DRIP developers
...
static const struct {
    ...
    {ChainType::DRIP, QAPP_APP_NAME_DRIP, 0, 0},
...
{
    std::string titleAddText = (networkId == ChainType::MAIN || networkId == ChainType::DRIP) ? "" : strprintf("[%s]", ChainTypeToString(networkId));
