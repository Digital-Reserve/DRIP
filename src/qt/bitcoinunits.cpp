...
QList<BitcoinUnit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(Unit::DRIP);
    unitlist.append(Unit::mDRIP);
    unitlist.append(Unit::uDRIP);
...
{
    switch (unit) {
    case Unit::DRIP: return 100'000'000;
    case Unit::mDRIP: return 100'000;
    case Unit::uDRIP: return 100;
...
{
    switch (unit) {
    case Unit::DRIP: return 8;
    case Unit::mDRIP: return 5;
    case Unit::uDRIP: return 2;
...
{
    switch (unit) {
    case BitcoinUnit::DRIP: return 0;
    case BitcoinUnit::mDRIP: return 1;
    case BitcoinUnit::uDRIP: return 2;
...
{
    switch (num) {
    case 0: return BitcoinUnit::DRIP;
    case 1: return BitcoinUnit::mDRIP;
    case 2: return BitcoinUnit::uDRIP;
