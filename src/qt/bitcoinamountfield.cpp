...
public:
    ...
    QSize minimumSizeHint() const override
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = GUIUtil::TextWidth(fm, BitcoinUnits::format(BitcoinUnit::DRIP, BitcoinUnits::maxMoney(), false, BitcoinUnits::SeparatorStyle::ALWAYS));
...
private:
    BitcoinUnit currentUnit{BitcoinUnit::DRIP};
    CAmount singleStep{CAmount(100000)}; // drips
    ...
    : QWidget(parent)
{
    ...
    amount->setMaximumWidth(280);
    amount->setMinimumWidth(200);

    QHBoxLayout *layout = new QHBoxLayout(this);
    layout->addWidget(amount);
    unit = new QValueComboBox(this);
    unit->setModel(new BitcoinUnits(this));
    unit->setMinimumWidth(100);  // Ensure unit names aren't truncated
