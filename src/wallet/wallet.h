...
//! -fallbackfee default
//! Set to a reasonable value so GUI users can send transactions without waiting for fee estimation
...
static const CAmount DEFAULT_CONSOLIDATE_FEERATE{10000}; // 10 drip/vbyte
/**
...
//! Discourage users to set fees higher than this amount (in drips) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in drips)
...
public:
    ...
    /** Absolute maximum transaction fee (in drips) used by default for the wallet */
