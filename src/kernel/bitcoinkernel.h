 ...
 *
 * This header currently exposes an API for interacting with parts of DRIP
 ...
 * also not yet included in releases of DRIP.
 *
...
/**
 * Function signature for the global logging callback. All drip kernel
