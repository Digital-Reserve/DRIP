// Copyright (c) 2012-present The DRIP developers
...
BOOST_AUTO_TEST_CASE(patharg)
{
    ...
    const fs::path absolute_path{"/home/user/.drip"};
    ResetArgs(local_args, "-dir=/home/user/.drip");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), absolute_path);

    ResetArgs(local_args, "-dir=/root/../home/user/.drip");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), absolute_path);
    ...
    const fs::path relative_path{"user/.drip"};
    ResetArgs(local_args, "-dir=user/.drip");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), relative_path);

    ResetArgs(local_args, "-dir=somewhere/../user/.drip");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), relative_path);
