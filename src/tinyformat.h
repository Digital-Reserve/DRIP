...
#include <algorithm>
#include <attributes.h> // Added for DRIP
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for DRIP
#include <util/string.h> // Added for DRIP
...
// Added for DRIP. Similar to std::runtime_format from C++26.
...
// Added for DRIP. Wrapper for checking format strings at compile time.
