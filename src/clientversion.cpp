...
//
#define GIT_COMMIT_ID "36abbe56ac050cd62c3f4cace728c5ce15d385db"
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/drip/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure DRIP copyright is not removed by accident
    if (copyright_devs.find("DRIP") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The DRIP developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/drip/drip>";
