...
/**
 * DRIP protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all DRIP non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
