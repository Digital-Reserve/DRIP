...
# Tor Settings (optional - for onion support)
...
$DripConfig | Out-File -FilePath "$DripDataDir\drip.conf" -Encoding ASCII
Write-Host "  Created: $DripDataDir\drip.conf" -ForegroundColor Green
...
if (Test-Path "$DripDataDir\drip.conf") {
